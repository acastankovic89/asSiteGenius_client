...
const UpdateArticle = () => {
  ...
  useEffect(() => {
    if (category) {
      ...
      setIntroText(category.introText);
      setPublished(category.published);
      setSlug(category.slug);
      setIntroImageName(category.introImage);
      setMainImageName(category.mainImage);
      setFormatedDate(category.publishDate);
    }
  }, [category]);
    ...
    try {
      ...
      if ((updateCategory.data.status = 200)) {
        toast.current.show({
          severity: "info",
          summary: "Success",
          detail: updateCategory.data.message,
        });
        setTimeout(() => {
        ...
        <div className="rightSideBar">
          <div className="actionBar">
            ...
            <div className="introImageUpload">
              ...
              />
              <Button onClick={() => setIntroImageName("")}>
                Remove image
              </Button>
            </div>
